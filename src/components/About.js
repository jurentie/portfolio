                ...
                <div className="container">
                    <div className="content">
                        ...
                        <motion.div transition={{delay: .5, duration: 1}} initial={{opacity:0}} whileInView={{opacity: 1}} viewport={{ once: true }}> 
                            ...
                            <p>
                                When I'm not immersed in code, you can find me playing my saxophone in the <span className="DGMC"><a href="https://www.mhfb.org/" target="_">Mile High Freedom Band</a></span>, experimenting with new recipes 
